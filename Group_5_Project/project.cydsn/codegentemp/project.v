...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("7044f78f-bac6-4c82-9dce-dcdd6fc3d162/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7044f78f-bac6-4c82-9dce-dcdd6fc3d162/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_v3_10_5 (
	...
	cy_clock_v1_0
		#(.id("bc933d12-bfed-4355-b3a7-3aa254768357/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bc933d12-bfed-4355-b3a7-3aa254768357/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    Timer_v2_80_3 WaveTimer (
        ...
        .tc(Net_76),
        .trigger(1'b1));
    defparam WaveTimer.CaptureCount = 2;
    defparam WaveTimer.CaptureCounterEnabled = 0;
    defparam WaveTimer.DeviceFamily = "PSoC5";
    defparam WaveTimer.InterruptOnCapture = 0;
    defparam WaveTimer.InterruptOnTC = 1;
    defparam WaveTimer.Resolution = 16;
    defparam WaveTimer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("e5e4851c-36e4-4b92-977d-c41661906a32"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam IDAC_1.Initial_Value = 120;
	...
	cy_psoc3_pins_v1_10
		#(.id("5a1cb063-5547-4542-a8d2-c994230fce41"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
